...
#. Click the camera icon in the top right of the viewport to switch to camera view, or go to *View* -> *Cameras* -> *Active Camera*, or Press numpad '0'.
#. Press the 'n' key to open the viewport's side tabs if they are not visible already.

    .. image:: images/properties_tabs.jpg
        :alt: Properties Tab

#. Go to the tab called *P.Plotter*.
